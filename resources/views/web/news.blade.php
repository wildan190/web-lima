    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .pagination-wrapper {
                ...
                padding-left: 10px;
                padding-right: 10px;
                /* Memberikan ruang pada pagination */
            }

            .pagination li a,
            .pagination li span {
                padding: 8px 12px;
                /* Menambah ruang pada tombol pagination */
                font-size: 14px;
            }
        ...
        @media (max-width: 1280px) {
            .news-wrapper {
                padding: 24px 3rem;
                /* Mengurangi padding untuk perangkat yang lebih kecil */
            }
        }
        ...
        @media (max-width: 768px) {
            .nw-grid {
                ...
                gap: 16px;
                /* Mengurangi jarak antar item grid */
            }
        }
                    ...
                    <a href="{{ route('news.detail', $first->slug) }}" class="press-card press-large">
                        ...
                        <div class="press-content">
                            <div class="press-meta">
                                ...
                                <span>{{ \Carbon\Carbon::parse($first->date ? $first->date : $first->created_at)->format('j M Y') }}</span>
                            </div>
                    ...
                    @if ($second)
                        <a href="{{ route('news.detail', $second->slug) }}" class="press-card">
                            ...
                            <div class="press-content">
                                <div class="press-meta">
                                    <span>Oleh Admin</span>
                                    <span>{{ \Carbon\Carbon::parse($second->date ? $second->date : $second->created_at)->format('j M Y') }}</span>
                                </div>
                    ...
                    @foreach ($rest as $item)
                        <a href="{{ route('news.detail', $item->slug) }}" class="press-card">
                            ...
                            <div class="press-content">
                                <div class="press-meta">
                                    <span>Oleh Admin</span>
                                    <span>{{ \Carbon\Carbon::parse($item->date ? $item->date : $item->created_at)->format('j M Y') }}</span>
                                </div>
